"""SETTING_SPECS-Permalink-Muster, Presets und Zufalls-Seed-Button (Standardmuster aus dem Demo-Portfolio, siehe xgb_presets.py in xgboost-demo)."""
...
SETTING_SPECS = {
    ...
    "num_leaves_slider": SettingSpec("nl", int, C.DEFAULT_NUM_LEAVES, C.NUM_LEAVES_MIN, C.NUM_LEAVES_MAX),
    "depth_slider": SettingSpec("depth", int, C.DEFAULT_DEPTH, C.DEPTH_MIN, C.DEPTH_MAX),
    "max_bin_slider": SettingSpec("bin", int, C.DEFAULT_MAX_BIN, C.MAX_BIN_MIN, C.MAX_BIN_MAX),
...
PRESET_KEYS = {"task": "task_select", "num_leaves": "num_leaves_slider", "depth": "depth_slider", "max_bin": "max_bin_slider", "n_rounds": "n_rounds_slider", "lr": "lr_slider",
               "lam": "lam_slider", "gamma": "gamma_slider", "min_child_weight": "mcw_slider", "subsample": "subsample_slider", "n": "n_slider", "n_noise": "n_noise_slider",
